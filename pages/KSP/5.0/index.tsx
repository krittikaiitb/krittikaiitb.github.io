...
var resources:OneProps[] = [
    {name: "Eclipsing Binaries", img: `/img/ksp/eclipse_binary.png`, link: `/KSPReports/2024/Eclipsing Binaries/KSP_5_0_EB_Project_Report.pdf`},
    {name: "Hunt for the QCD axion dark matter using gravitational microlensing", img: `/img/ksp/primordial_blackhole.png`, link: `/KSPReports/2024/Hunt for the QCD axion dark matter using gravitational microlensing/KSP_Project_Report_DarkMatterAxionsPBH.pdf`},
    {name: "Modifications of stellar structure equations due to Rotation and Tidal stretching", img: `/img/ksp/rotate.png`, link: `/KSPReports/2024/Modifications of stellar structure equations due to Rotation and Tidal stretching/KSPReport.pdf`},
    {name: "Prospects of LSST, ILMT and AXIS for searching SMBHB candidates", img: `/img/ksp/agn.png`, link: `/KSPReports/2024/Prospects of LSST, ILMT and AXIS for searching SMBHB candidates/KSP_final.pdf`}
]
